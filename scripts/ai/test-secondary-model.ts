/**
 * Test Secondary Model (openai/gpt-oss-20b) Directly
...
async function testSecondaryModel() {
  console.log(`${CYAN}Testing Secondary Model (openai/gpt-oss-20b)${RESET}\n`);
  
  try {
    // Create provider with secondary model override
    ...
    console.log(`\n${GREEN}Secondary model test passed${RESET}`);
    process.exit(0);
